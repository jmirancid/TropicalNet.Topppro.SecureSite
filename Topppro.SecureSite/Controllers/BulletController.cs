...
namespace Topppro.SecureSite.Controllers
{
    public class BulletController :
        LayoutController<Bullet, IBulletBusiness>
    {
        ...
        public BulletController(IBulletBusiness business, IProductBusiness bizProduct, ICultureBusiness bizCulture) :
            base(business)
        {
